...
This will create a flexdashboard using `rmarkdown` and save it to `out_dir`. Some templates use Shiny runtime and launch in your web browser as an app. For these templates, there is no static HTML document saved to `out_dir`.
