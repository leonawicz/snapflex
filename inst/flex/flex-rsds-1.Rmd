...
a2 <- paste0("The colored trend lines and scatter plot of projected model outputs are faded to highlight the mean trend over projected period. ", pct_change_statement, "\n\n")
