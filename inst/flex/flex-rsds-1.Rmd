...
a2 <- "The colored trend lines and scatter plot of projected model outputs are faded to highlight the mean trend over the climate model time period (2006 - 2100). Average total change in RSDS as well as average change per decade  over this period is shown on the plot.\n\n"
a3 <- paste("The regression equation for the", contrast, "trend line is also included. This helps show any trend in RSDS with time, but keep in mind that a simple linear regression model of mean annual RSDS on time is not intended to explain much of the variation in RSDS across models, hence the low R-squared.\n\n")
a <- paste0("***\n\n", a1, a2, a3)
```
